...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div id="fh5co-search-map">
			<div class="search-property" style="width: 100%;height:400px">
				<div class="s-holder">  </div>
						
				<form method="get" action="HotelsController">
					<div class="col-xxs-12 col-xs-12 text-center">
                                            <h1 style="color: white">Welcome to HotelOffers</h1>
							<p><button type="submit" class="btn  btn-lg" style="background-color: #393e46;margin-top:100px">See Hotels Offers</button></p>
					</div>
                                </form>
					</div>
				</div>
			...
			<div id="footer">
				<div class="container">
					<div class="row row-bottom-padded-md">
						<div class="col-md-3">
							<h3 class="section-title">About HotelsOffers</h3>
